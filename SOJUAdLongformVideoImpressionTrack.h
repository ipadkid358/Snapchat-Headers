...
@property (nonatomic,copy,readonly) NSNumber * longformMediaDurationSeconds; 
...
-(NSNumber *)longformMediaDurationSeconds;
-(NSString *)creativeId;
...
@property (nonatomic,copy,readonly) NSNumber * longformMediaDurationSeconds;                           //@synthesize longformMediaDurationSeconds=_longformMediaDurationSeconds - In the implementation block
