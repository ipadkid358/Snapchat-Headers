...
@class SCProfileCellIconView, UILabel, SCProfileHorizontalCarouselCellViewModel, NSString;

@interface SCProfileCollectionViewHorizontalCarouselCell : SCUnifiedProfileCollectionViewCell <SCSearchActionable> {
