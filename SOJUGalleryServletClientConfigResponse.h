...
@property (nonatomic,copy,readonly) NSArray * defaultQueries; 
@property (nonatomic,copy,readonly) NSArray * blockedTags; 
@required
-(NSNumber *)backoffTime;
-(NSNumber *)serviceStatusCode;
-(NSNumber *)totalEntryCount;
-(NSArray *)defaultQueries;
-(NSArray *)blockedTags;
...
@property (nonatomic,copy,readonly) NSArray * defaultQueries;                     //@synthesize defaultQueries=_defaultQueries - In the implementation block
@property (nonatomic,copy,readonly) NSArray * blockedTags;                        //@synthesize blockedTags=_blockedTags - In the implementation block
