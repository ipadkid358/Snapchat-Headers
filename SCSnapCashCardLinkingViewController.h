...
@protocol SCSnapCashCardLinkingDelegate, SCChatMessageActionHandler;
@class SCSnapCashPaymentV3, SCCardTextField, SCButton, UILabel, UIImageView, UIScrollView, NSString;

@interface SCSnapCashCardLinkingViewController : SCGenericSettingsViewController <SCTextFieldDelegate, SCBackspaceTextFieldDelegate> {
...
@property (assign,nonatomic,__weak) id<SCSnapCashCardLinkingDelegate> delegate;                //@synthesize delegate=_delegate - In the implementation block
...
-(void)setDelegate:(id<SCSnapCashCardLinkingDelegate>)arg1 ;
-(void)dealloc;
-(id<SCSnapCashCardLinkingDelegate>)delegate;
-(void)loadView;
