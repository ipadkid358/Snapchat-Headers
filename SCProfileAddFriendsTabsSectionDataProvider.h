...
@class SCSearchEventListenerAnnouncer, SCAddFriendsSnapchatterDataProvider, NSArray, NSObject, NSString;

@interface SCProfileAddFriendsTabsSectionDataProvider : NSObject <SCSearchUpdateListener, SCSearchSectionDataProviding> {
