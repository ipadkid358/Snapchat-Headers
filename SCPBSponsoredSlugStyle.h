...
@property (nonatomic,copy) NSString * dropshadowColor; 
@property (nonatomic,retain) SCPBStrPoint * dropshadowOffset; 
@property (assign,nonatomic) BOOL hasDropshadowOffset; 
+(id)descriptor;
@end
