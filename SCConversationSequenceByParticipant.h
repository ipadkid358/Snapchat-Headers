...
@property (nonatomic,readonly) long long sequence;                       //@synthesize sequence=_sequence - In the implementation block
-(id)initWithParticipant:(id)arg1 sequence:(long long)arg2 ;
