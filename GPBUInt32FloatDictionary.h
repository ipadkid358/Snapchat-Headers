...
+(id)dictionaryWithFloat:(float)arg1 forKey:(unsigned)arg2 ;
+(id)dictionaryWithFloats:(const float*)arg1 forKeys:(const unsigned*)arg2 count:(unsigned long long)arg3 ;
+(id)dictionary;
