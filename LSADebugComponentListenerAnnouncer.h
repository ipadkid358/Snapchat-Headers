...
#import <Snapchat/LSADebugComponentListener.h>
...
@interface LSADebugComponentListenerAnnouncer : NSObject <LSADebugComponentListener> {
	...
	mutex _mutex;
	shared_ptr<std::__1::vector<__weak id<LSADebugComponentListener>, std::__1::allocator<__weak id<LSADebugComponentListener> > > >* _listeners;
