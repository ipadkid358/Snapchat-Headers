...
@property (nonatomic,copy) NSString * requestTiming; 
@property (assign,nonatomic) int scale; 
@property (nonatomic,copy) NSString * assetURL; 
@property (nonatomic,copy) NSString * assetSignature; 
@property (assign,nonatomic) int preloadLimit; 
@property (nonatomic,copy) NSString * animationGroup; 
