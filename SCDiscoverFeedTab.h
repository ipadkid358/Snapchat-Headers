...
@property (nonatomic,readonly) unsigned long long feedType;              //@synthesize feedType=_feedType - In the implementation block
...
-(id)initWithFeedType:(unsigned long long)arg1 displayText:(id)arg2 loggingKey:(id)arg3 ;
-(NSString *)loggingKey;
