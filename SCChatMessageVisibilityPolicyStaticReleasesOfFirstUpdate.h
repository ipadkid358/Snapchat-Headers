...
@class SCChatMessageVisibilityPolicyTrustChat, NSString;
...
@property (nonatomic,readonly) SCChatMessageVisibilityPolicyTrustChat * delegate;              //@synthesize delegate=_delegate - In the implementation block
...
-(id)init;
-(SCChatMessageVisibilityPolicyTrustChat *)delegate;
@end
