...
@class SCUnifiedProfileSession, SCSearchEventListenerAnnouncer, NSObject, NSString;

@interface SCFriendProfileIdentityCarouselDataProvider : NSObject <SCFriendProfileManagerListener, SCSearchSectionDataProviding> {
...
-(id)_createSectionDataModelFromProfileSession;
-(void)_configureStoryCell:(id)arg1 ;
-(void)_configureSnapcodeCell:(id)arg1 ;
-(void)_configureMapCell:(id)arg1 ;
-(id)_generateMapCellSubtitleText:(id)arg1 ;
