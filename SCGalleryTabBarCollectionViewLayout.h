...
@property (nonatomic,copy) NSArray * itemWidthArray;              //@synthesize itemWidthArray=_itemWidthArray - In the implementation block
-(void)setItemWidthArray:(NSArray *)arg1 ;
-(NSArray *)itemWidthArray;
