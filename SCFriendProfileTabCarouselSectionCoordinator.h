...
@interface SCFriendProfileTabCarouselSectionCoordinator : NSObject <SCProfilePageSectionContentCoordinating>
...
-(id)_createUsageCarouselSectionDescriptor:(BOOL)arg1 ;
@end
