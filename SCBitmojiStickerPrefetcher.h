...
#import <Snapchat/SCBitmojiPrefetcher.h>

@protocol OS_dispatch_queue;
@class NSObject, NSMutableArray, SCUserSession, NSString;
...
-(void)prefetchJobs:(long long)arg1 imageType:(unsigned long long)arg2 block:(/*^block*/id)arg3 ;
