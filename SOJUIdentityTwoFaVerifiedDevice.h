...
@property (nonatomic,copy,readonly) NSNumber * lastLogin; 
@required
-(NSString *)idValue;
-(NSNumber *)lastLogin;
-(NSString *)name;
...
@property (nonatomic,copy,readonly) NSNumber * lastLogin;              //@synthesize lastLogin=_lastLogin - In the implementation block
