...
#import <Snapchat/SCFreeDiskSpaceMonitorListener.h>
...
@interface SCFreeDiskSpaceMonitorListenerAnnouncer : NSObject <SCFreeDiskSpaceMonitorListener> {
	...
	mutex _mutex;
	shared_ptr<std::__1::vector<__weak id<SCFreeDiskSpaceMonitorListener>, std::__1::allocator<__weak id<SCFreeDiskSpaceMonitorListener> > > >* _listeners;
