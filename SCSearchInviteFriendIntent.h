...
@property (nonatomic,readonly) Friend * friendObj;                  //@synthesize friendObj=_friendObj - In the implementation block
...
-(Friend *)friendObj;
-(id)initWithFriend:(id)arg1 updateInviteButtonBlock:(/*^block*/id)arg2 ;
-(id)updateBlock;
@end
