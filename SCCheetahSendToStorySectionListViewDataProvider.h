...
@class SCSearchEventListenerAnnouncer, SCUserSession, SCCheetahSendToStoryDataSource, SCCheetahSendToRecipientDataProvider, SCSendToSelectionStateManager, SCSearchQuery, NSObject, NSString;

@interface SCCheetahSendToStorySectionListViewDataProvider : NSObject <SCSearchSectionDataProviding, SCSearchUpdateListener, SCSearchEventListener> {
...
-(id)initWithUserSession:(id)arg1 dataSource:(id)arg2 recipientDataProvider:(id)arg3 selectionStateManager:(id)arg4 ;
