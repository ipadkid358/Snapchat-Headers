...
@interface SCGalleryEGOCipherKeyProviderListenerAnnouncer : NSObject <SCGalleryEGOCipherKeyProviderListener> {
	...
	mutex _mutex;
	shared_ptr<std::__1::vector<__weak id<SCGalleryEGOCipherKeyProviderListener>, std::__1::allocator<__weak id<SCGalleryEGOCipherKeyProviderListener> > > >* _listeners;
