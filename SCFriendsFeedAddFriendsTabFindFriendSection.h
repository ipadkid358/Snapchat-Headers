...
@class SCAddFriendsSnapchatterDataProvider, SCAddFriendsEmptyStateCollectionViewCell, SCSearchCollectionViewSectionUpdateModel, NSString;

@interface SCFriendsFeedAddFriendsTabFindFriendSection : NSObject <SCSearchUpdateListener, SCSearchCollectionViewSection, SCSearchActionable> {

	SCAddFriendsSnapchatterDataProvider* _dataProvider;
	SCAddFriendsEmptyStateCollectionViewCell* _emptyStateCell;
