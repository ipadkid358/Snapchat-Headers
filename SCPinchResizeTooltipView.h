...
@interface SCPinchResizeTooltipView : UIImageView {
	...
	BOOL _shouldCheckTooltipSeenState;
	BOOL _didResizeBrush;
...
@property (assign,nonatomic) BOOL didResizeBrush;                              //@synthesize didResizeBrush=_didResizeBrush - In the implementation block
-(unsigned long long)currentLoopCount;
-(void)setCurrentLoopCount:(unsigned long long)arg1 ;
-(void)setDidResizeBrush:(BOOL)arg1 ;
