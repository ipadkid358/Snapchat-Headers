...
@class SCContextMetaFeatureManager, SCStickerTagFuzzySearch, NSCalendar, NSMutableDictionary;
...
-(void)_getRecommendedStickersWithAlltags:(id)arg1 key:(id)arg2 completionHandler:(/*^block*/id)arg3 ;
