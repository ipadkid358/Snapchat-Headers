...
@class SOJUUnlockablesOndemandTemplateCategory, SOJUUnlockablesOndemandAssetDraftList, SCOnDemandGeofilterBlurredBackgroundView, SCHeader, UIImageView, UICollectionView, NSIndexPath, SCOnDemandGeofilterCollectionViewLayout, SCOnDemandGeofilterDraftsEmptyStateView, NSString;
