...
@property (nonatomic,copy,readonly) SCChatAddressMediaCardContent * addressMediaCardContent;              //@synthesize addressMediaCardContent=_addressMediaCardContent - In the implementation block
@property (readonly) unsigned long long hash; 
@property (readonly) Class superclass; 
@property (copy,readonly) NSString * description; 
@property (copy,readonly) NSString * debugDescription; 
-(SCChatAddressMediaCardContent *)addressMediaCardContent;
