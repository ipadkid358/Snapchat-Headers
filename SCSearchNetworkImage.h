...
@class SCMedia, NSValue, SCSearchNetworkImageDownloadInfo, NSURL, NSString, UIImage;
...
-(id)internalInit;
-(void)matchThumbnailMedia:(/*^block*/id)arg1 plainURL:(/*^block*/id)arg2 favicon:(/*^block*/id)arg3 bitmojiSelfie:(/*^block*/id)arg4 bitmojiAvatar:(/*^block*/id)arg5 image:(/*^block*/id)arg6 ;
