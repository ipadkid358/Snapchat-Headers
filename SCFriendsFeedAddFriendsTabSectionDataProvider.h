...
@class SCSearchEventListenerAnnouncer, SCAddFriendsSnapchatterDataProvider, NSString, NSObject;

@interface SCFriendsFeedAddFriendsTabSectionDataProvider : NSObject <SCSearchUpdateListener, SCSearchSectionDataProviding> {
...
-(id)initWithDataProvider:(id)arg1 imageDownloader:(id)arg2 sectionType:(id)arg3 ;
