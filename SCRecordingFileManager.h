...
@property (nonatomic,retain) SCManagedRecordedVideo * recordedVideo;              //@synthesize recordedVideo=_recordedVideo - In the implementation block
-(BOOL)discardRecordedVideoIfNecessary;
-(SCManagedRecordedVideo *)recordedVideo;
-(void)removeActiveRecordingURLOfRecordedVideo;
-(void)setRecordedVideo:(SCManagedRecordedVideo *)arg1 ;
