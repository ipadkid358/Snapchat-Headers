...
@property (nonatomic,copy,readonly) NSString * callType; 
@property (nonatomic,copy,readonly) NSNumber * connectedTimestamp; 
@required
-(NSString *)idValue;
...
@property (nonatomic,copy,readonly) NSString * callType;                                  //@synthesize callType=_callType - In the implementation block
@property (nonatomic,copy,readonly) NSNumber * connectedTimestamp;                        //@synthesize connectedTimestamp=_connectedTimestamp - In the implementation block
