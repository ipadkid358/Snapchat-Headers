...
@property (nonatomic,readonly) unsigned long long attachmentTriggerType;              //@synthesize attachmentTriggerType=_attachmentTriggerType - In the implementation block
...
-(unsigned long long)attachmentTriggerType;
