...
@protocol SCOurStorySettingsMediaProvider, SCSearchSectionDataProvidingDelegate, NSCopying, SCPerforming;
@class SCSearchEventListenerAnnouncer, SCOurStorySettingsDataSource, NSMutableDictionary, NSObject, NSString;

@interface SCOurStorySettingsDataProvider : NSObject <SCSearchUpdateListener, SCSearchSectionDataProviding> {
...
-(id)initWithDataSource:(id)arg1 mediaProvider:(id)arg2 ;
