...
@class SCSnapchattersDataRequestTracker;

@interface SCSnapchattersAdaptedDataTracker : NSObject <SCAddFriendsSnapchattersDataTracking> {

	SCSnapchattersDataRequestTracker* _snapchattersDataTracker;
