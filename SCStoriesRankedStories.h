...
@interface SCStoriesRankedStories : SCDocObject <NSCopying> {
...
@property (nonatomic,copy,readonly) NSArray * rankedValues;              //@synthesize rankedValues=_rankedValues - In the implementation block
+(id)immutableObjectParse:(const void*)arg1 ;
+(SCDocObjectClassFunctionPointer*)objectClassFunctionPointer;
+(const char*)table;
-(id)initWithType:(long long)arg1 rankedValues:(id)arg2 ;
