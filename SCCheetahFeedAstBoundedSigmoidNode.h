...
@property (nonatomic,readonly) double midpoint;                                   //@synthesize midpoint=_midpoint - In the implementation block
@property (nonatomic,readonly) double endpoint;                                   //@synthesize endpoint=_endpoint - In the implementation block
