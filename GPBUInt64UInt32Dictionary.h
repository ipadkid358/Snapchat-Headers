...
+(id)dictionaryWithUInt32:(unsigned)arg1 forKey:(unsigned long long)arg2 ;
+(id)dictionaryWithUInt32s:(const unsigned*)arg1 forKeys:(const unsigned long long*)arg2 count:(unsigned long long)arg3 ;
+(id)dictionary;
