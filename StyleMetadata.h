...
@class StyleInstanceKey, NSString;

@interface StyleMetadata : GPBMessage

@property (nonatomic,retain) StyleInstanceKey * styleKey; 
@property (assign,nonatomic) BOOL hasStyleKey; 
@property (nonatomic,copy) NSString * minAppVersion; 
@property (nonatomic,copy) NSString * minIosVersion; 
@property (nonatomic,copy) NSString * minAndroidVersion; 
+(id)descriptor;
@end
