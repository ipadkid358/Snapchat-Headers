...
@property (nonatomic,__weak,readonly) id<SCDeepLinkUserActionDelegate> userActionDelegate;              //@synthesize userActionDelegate=_userActionDelegate - In the implementation block
+(id)scopeWithUserActionDelegate:(id)arg1 ;
-(id<SCDeepLinkUserActionDelegate>)userActionDelegate;
