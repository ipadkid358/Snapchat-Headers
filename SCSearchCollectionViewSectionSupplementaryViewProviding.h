...
@property (assign,nonatomic,__weak) id<SCSearchCollectionViewSectionSupplementaryViewProviderDelegate> supplementaryViewProviderDelegate; 
...
-(void)setSupplementaryViewProviderDelegate:(id)arg1;
