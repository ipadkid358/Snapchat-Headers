...
@interface SCVideoTranscodingInputVideoProviderBuilder : NSObject {
...
+(id)withVideoTranscodingInputVideoProvider:(id)arg1 ;
-(id)setInputVideoAsset:(id)arg1 ;
-(id)setRawVideoDataURL:(id)arg1 ;
-(id)setVideoTransform:(CGAffineTransform)arg1 ;
-(id)build;
