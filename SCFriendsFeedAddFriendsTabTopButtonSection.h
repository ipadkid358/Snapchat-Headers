...
@class SCSearchEventListenerAnnouncer, SCAddFriendsSnapchatterDataProvider, SCFriendsFeedAddFriendsTabActionButtonCell, SCSearchCollectionViewSectionUpdateModel, NSString;

@interface SCFriendsFeedAddFriendsTabTopButtonSection : NSObject <SCSearchUpdateListener, SCSearchCollectionViewSection, SCSearchActionable> {

	SCSearchEventListenerAnnouncer* _eventAnnouncer;
	SCAddFriendsSnapchatterDataProvider* _dataProvider;
	SCFriendsFeedAddFriendsTabActionButtonCell* _buttonHolderCell;
