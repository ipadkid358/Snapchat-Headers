...
@property (nonatomic,copy,readonly) NSNumber * isBlock; 
@required
-(NSString *)idValue;
-(NSString *)reqToken;
-(NSNumber *)isBlock;
...
@property (nonatomic,copy,readonly) NSNumber * isBlock;                //@synthesize isBlock=_isBlock - In the implementation block
