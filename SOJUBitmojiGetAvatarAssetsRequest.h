...
@property (nonatomic,copy,readonly) NSString * deploymentEnvironment; 
@property (nonatomic,copy,readonly) NSString * overrideAvatarUserId; 
@required
-(NSString *)reqToken;
-(NSString *)deploymentEnvironment;
-(NSString *)overrideAvatarUserId;
-(NSString *)timestamp;
-(NSString *)username;
-(NSString *)groupId;
...
@property (nonatomic,copy,readonly) NSString * deploymentEnvironment;              //@synthesize deploymentEnvironment=_deploymentEnvironment - In the implementation block
@property (nonatomic,copy,readonly) NSString * overrideAvatarUserId;               //@synthesize overrideAvatarUserId=_overrideAvatarUserId - In the implementation block
