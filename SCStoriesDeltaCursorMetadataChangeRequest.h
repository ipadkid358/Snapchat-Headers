...
@property (assign,nonatomic) double timestampUnixSeconds;              //@synthesize timestampUnixSeconds=_timestampUnixSeconds - In the implementation block
...
-(id)initWithRowid:(long long)arg1 type:(long long)arg2 value:(id)arg3 timestampUnixSeconds:(double)arg4 ;
-(id)_storiesDeltaCursorMetadata;
-(void)setTimestampUnixSeconds:(double)arg1 ;
