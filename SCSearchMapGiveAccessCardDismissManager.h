...
#import <Snapchat/SCSearchMapGiveAccessCardDismisser.h>
#import <Snapchat/SCSearchUpdateAnnouncing.h>

@class SCSearchUpdateListenerAnnouncer, NSString;
...
-(BOOL)hasMapGiveAccessCardBeenDismissed;
-(void)willShowMapPreTypeCard;
-(BOOL)canShowMapPreTypeCard;
-(id)init;
@end
