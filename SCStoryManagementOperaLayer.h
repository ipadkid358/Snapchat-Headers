...
@class SCOperaPage, SCStoryManagementSnapDataModel, NSString;
...
@property (nonatomic,copy,readonly) SCStoryManagementSnapDataModel * snapDataModel;              //@synthesize snapDataModel=_snapDataModel - In the implementation block
...
-(SCStoryManagementSnapDataModel *)snapDataModel;
