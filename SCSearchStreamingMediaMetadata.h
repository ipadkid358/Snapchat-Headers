...
@property (nonatomic,readonly) unsigned long long muxedMediaSize;              //@synthesize muxedMediaSize=_muxedMediaSize - In the implementation block
-(id)initWithMuxedMediaSize:(unsigned long long)arg1 ;
-(unsigned long long)muxedMediaSize;
