...
+(id)dictionaryWithUInt32:(unsigned)arg1 forKey:(int)arg2 ;
+(id)dictionaryWithUInt32s:(const unsigned*)arg1 forKeys:(const int*)arg2 count:(unsigned long long)arg3 ;
+(id)dictionary;
