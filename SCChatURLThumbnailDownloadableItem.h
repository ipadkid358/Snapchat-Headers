...
@property (nonatomic,copy,readonly) SCChatURLMediaCardContent * urlMediaCardContent;              //@synthesize urlMediaCardContent=_urlMediaCardContent - In the implementation block
@property (readonly) unsigned long long hash; 
@property (readonly) Class superclass; 
@property (copy,readonly) NSString * description; 
@property (copy,readonly) NSString * debugDescription; 
-(id)initWithUrlMediaCardContent:(id)arg1 conversationId:(id)arg2 ;
-(SCChatURLMediaCardContent *)urlMediaCardContent;
