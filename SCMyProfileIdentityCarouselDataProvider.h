...
@interface SCMyProfileIdentityCarouselDataProvider : NSObject <SCSearchSectionDataProviding> {
...
-(id)_generateMapCellSubtitleText;
-(id)_generateExploreSubtitle:(id)arg1 ;
-(id)_generateLocalitySubtitle:(id)arg1 ;
