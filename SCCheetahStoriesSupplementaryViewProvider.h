...
@class SCCheetahStoriesSectionHeaderViewModel, NSDictionary, NSString;

@interface SCCheetahStoriesSupplementaryViewProvider : NSObject <SCSearchCollectionViewSectionSupplementaryViewProviding, SCSearchCollectionViewSupplementaryViewModelsConfigurable> {

	SCCheetahStoriesSectionHeaderViewModel* _viewModel;
