...
@property (nonatomic,copy,readonly) NSNumber * expirySecs; 
...
@property (nonatomic,copy,readonly) NSNumber * expirySecs;              //@synthesize expirySecs=_expirySecs - In the implementation block
