...
@class SCSearchAttachmentsActionHandler, SCSearchDynamicStoryActionHandler, SCSearchEventListenerAnnouncer, SCSearchNavigationCoordinator, UIViewController, NSString;
