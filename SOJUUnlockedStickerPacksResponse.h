...
@property (nonatomic,copy,readonly) NSString * stickerPacksCursor; 
@required
-(NSArray *)stickerPacks;
-(NSString *)stickerPacksCursor;
...
@property (nonatomic,copy,readonly) NSString * stickerPacksCursor;              //@synthesize stickerPacksCursor=_stickerPacksCursor - In the implementation block
