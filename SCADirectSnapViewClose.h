...
-(void)setSessionStart:(BOOL)arg1 ;
-(BOOL)getIsOperaError;
-(void)setIsOperaError:(BOOL)arg1 ;
-(BOOL)getIsOperaViewDisplayed;
-(void)setIsOperaViewDisplayed:(BOOL)arg1 ;
-(BOOL)getWithoutOperaCallback;
-(void)setWithoutOperaCallback:(BOOL)arg1 ;
-(id)init;
