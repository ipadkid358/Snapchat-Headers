...
@class UILabel, SCAddFriendsEmptyStateView, NSString;

@interface SCDiscoverFeedFriendStoriesSectionEmptyStateCollectionViewCell : UICollectionViewCell <SCAddFriendsEmptyStateViewDelegate, SCSearchViewModelConfigurable, SCSearchActionable> {
