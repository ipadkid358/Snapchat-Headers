...
@property (nonatomic,__weak,readonly) id<SCWebProxyHeaderTransformLayerDelegate> delegate;              //@synthesize delegate=_delegate - In the implementation block
...
-(id<SCWebProxyHeaderTransformLayerDelegate>)delegate;
@end
