...
@property (nonatomic,retain) NSMutableDictionary * updateDict; 
@property (nonatomic,readonly) unsigned long long updateDict_Count; 
@property (assign,nonatomic) long long timestamp; 
@property (nonatomic,copy) NSString * curatorName; 
@property (nonatomic,copy) NSString * curatorEmail; 
@property (nonatomic,copy) NSString * curationType; 
+(id)descriptor;
@end
