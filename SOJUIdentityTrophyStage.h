...
@property (nonatomic,copy,readonly) NSNumber * achievedTimestamp; 
@required
-(NSNumber *)achievedTimestamp;
-(NSString *)label;
-(NSString *)status;
-(NSString *)unicode;
...
@property (nonatomic,copy,readonly) NSNumber * achievedTimestamp;              //@synthesize achievedTimestamp=_achievedTimestamp - In the implementation block
