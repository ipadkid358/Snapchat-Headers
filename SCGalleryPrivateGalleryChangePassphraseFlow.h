...
@property (assign,nonatomic,__weak) id<SCGalleryPrivateGalleryChangePassphraseFlowDelegate> delegate;              //@synthesize delegate=_delegate - In the implementation block
...
-(void)setDelegate:(id<SCGalleryPrivateGalleryChangePassphraseFlowDelegate>)arg1 ;
-(id<SCGalleryPrivateGalleryChangePassphraseFlowDelegate>)delegate;
-(void)_reset;
-(void)start;
