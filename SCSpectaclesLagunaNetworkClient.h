...
@class VLKAmbaResponse, SCSpectaclesStream, SCSpectaclesMessageBuffer, SCSpectaclesAEADPacketEncryptor, SCWeakTimer, NSString;
...
@property (assign,nonatomic) unsigned long long outstandingResponses;                            //@synthesize outstandingResponses=_outstandingResponses - In the implementation block
...
-(unsigned long long)outstandingResponses;
-(void)setOutstandingResponses:(unsigned long long)arg1 ;
