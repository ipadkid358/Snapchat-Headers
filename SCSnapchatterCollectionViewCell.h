...
@class SCLazy, SCSnapchatterView, UILongPressGestureRecognizer, UIColor, NSString;

@interface SCSnapchatterCollectionViewCell : UICollectionViewCell <SCSnapchatterCellViewActionHandling, SCSearchViewModelConfigurable, SCSearchSeparatorConfigurable, SCSearchActionable, SCSearchRoundedCornerConfigurable> {
