...
@class SCSearchSession, SCGallerySearchRequest, NSArray, SCSearchEventListenerAnnouncer, NSObject, NSString;
...
-(id)initWithSearchSession:(id)arg1 exactMatch:(BOOL)arg2 ;
