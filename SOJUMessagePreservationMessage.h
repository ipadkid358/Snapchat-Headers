...
@property (nonatomic,copy,readonly) NSNumber * preserved; 
...
@property (nonatomic,copy,readonly) NSNumber * preserved;                                 //@synthesize preserved=_preserved - In the implementation block
