...
#import <Snapchat/SCSearchSeeMoreViewDelegate.h>
...
@class SCSearchSeeMoreView, NSString;

@interface SCSearchResultViewMoreCollectionViewCell : UICollectionViewCell <SCSearchSeeMoreViewDelegate, SCSearchViewModelConfigurable, SCSearchRoundedCornerConfigurable> {
...
@property (assign,nonatomic,__weak) id<SCSearchResultViewMoreCollectionViewCellDelegate> delegate;              //@synthesize delegate=_delegate - In the implementation block
...
-(void)layoutSubviews;
-(void)setDelegate:(id<SCSearchResultViewMoreCollectionViewCellDelegate>)arg1 ;
-(id<SCSearchResultViewMoreCollectionViewCellDelegate>)delegate;
