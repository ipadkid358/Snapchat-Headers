...
+(id)dictionaryWithInt64:(long long)arg1 forKey:(unsigned)arg2 ;
+(id)dictionaryWithInt64s:(const long long*)arg1 forKeys:(const unsigned*)arg2 count:(unsigned long long)arg3 ;
+(id)dictionary;
