...
@class SCCaptureFaceDetectorTrigger, SCCaptureFaceDetectionParser;


@protocol SCCaptureFaceDetector <NSObject>
@property (nonatomic,readonly) SCCaptureFaceDetectorTrigger * trigger; 
@property (nonatomic,readonly) SCCaptureFaceDetectionParser * parser; 
@required
