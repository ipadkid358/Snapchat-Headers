...
@protocol SCChatCellGestureDelegateSCChatFullscreenMediaChatTableCellDelegateSCChatCellMessageStateUpdateDelegate;
@class SCChatViewModelForChat, UIViewController, NSString;
