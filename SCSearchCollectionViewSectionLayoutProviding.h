...
@protocol SCSearchCollectionViewSectionLayoutProviding <NSObject>
@property (assign,nonatomic,__weak) id<SCSearchCollectionViewSectionLayoutProvidingDataSource> dataSource; 
@required
