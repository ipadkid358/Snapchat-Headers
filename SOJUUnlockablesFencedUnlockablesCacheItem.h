...
@property (nonatomic,copy,readonly) NSString * cellToken; 
@property (nonatomic,copy,readonly) NSString * status; 
@property (nonatomic,copy,readonly) NSString * signature; 
@property (nonatomic,copy,readonly) NSArray * unlockablesIds; 
@required
-(NSString *)cellToken;
-(NSArray *)unlockablesIds;
-(NSString *)status;
-(NSString *)signature;
...
@property (nonatomic,copy,readonly) NSString * cellToken;                  //@synthesize cellToken=_cellToken - In the implementation block
...
@property (nonatomic,copy,readonly) NSArray * unlockablesIds;              //@synthesize unlockablesIds=_unlockablesIds - In the implementation block
