...
@property (nonatomic,copy,readonly) NSNumber * videoPlatform; 
@required
-(NSString *)videoId;
-(NSNumber *)videoPlatform;
...
@property (nonatomic,copy,readonly) NSNumber * videoPlatform;              //@synthesize videoPlatform=_videoPlatform - In the implementation block
