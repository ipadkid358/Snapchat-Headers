...
@class SCUserSession, SCPaymentBlocker, SCPayment, MobileSettingsViewController, NSString;
...
@property (nonatomic,retain) id<SCSnapCashBlockerResolutionResultDelegateV2> resolutionResultDelegate;              //@synthesize resolutionResultDelegate=_resolutionResultDelegate - In the implementation block
...
-(void)setResolutionResultDelegate:(id<SCSnapCashBlockerResolutionResultDelegateV2>)arg1 ;
-(void)resolveIfViewIsDoneAndDelegateAvailable;
-(BOOL)viewIsDone;
-(id<SCSnapCashBlockerResolutionResultDelegateV2>)resolutionResultDelegate;
-(BOOL)newNumberMode;
