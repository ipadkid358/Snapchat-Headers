...
+(BOOL)shouldRemoveInactiveFiltersFromCache;
+(double)accuracyForRemovingFiltersFromCache;
+(BOOL)shouldApplyAreaCheckToCachedFilters;
+(double)minAreaPercentForAreaCheck;
+(BOOL)shouldOptimizeLocData;
...
+(BOOL)unlockablesPreCacheEnabled;
+(BOOL)contextBasedFilteringEnabled;
@end
