...
@property (nonatomic,copy,readonly) NSString * unlockUrl; 
...
@property (nonatomic,copy,readonly) NSString * unlockUrl;              //@synthesize unlockUrl=_unlockUrl - In the implementation block
