...
@class SCChatV3ConversationStore, SCChatMediaCache;
...
@property (nonatomic,retain) SCChatMediaCache * chatMediaCache;              //@synthesize chatMediaCache=_chatMediaCache - In the implementation block
...
-(void)setChatMediaCache:(SCChatMediaCache *)arg1 ;
@end
