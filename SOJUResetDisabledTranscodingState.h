...
@property (nonatomic,copy,readonly) NSNumber * shouldReset; 
@property (nonatomic,copy,readonly) NSNumber * timestamp; 
@required
-(NSNumber *)shouldReset;
-(NSNumber *)timestamp;
...
@property (nonatomic,copy,readonly) NSNumber * shouldReset;              //@synthesize shouldReset=_shouldReset - In the implementation block
