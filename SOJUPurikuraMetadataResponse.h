...
@property (nonatomic,copy,readonly) NSArray * patterns; 
@required
-(NSArray *)patterns;
-(NSNumber *)version;
...
@property (nonatomic,copy,readonly) NSArray * patterns;              //@synthesize patterns=_patterns - In the implementation block
