...
@property (nonatomic,readonly) long long debugSource;                                 //@synthesize debugSource=_debugSource - In the implementation block
@property (nonatomic,copy,readonly) SCSearchStoryInfo * searchStoryInfo;              //@synthesize searchStoryInfo=_searchStoryInfo - In the implementation block
-(id)initWithDebugSource:(long long)arg1 searchStoryInfo:(id)arg2 ;
-(long long)debugSource;
