...
@protocol SCStoryManagementMediaProvider, SCStoryManagementPlayerProvider, SCSearchSectionDataProvidingDelegate, NSCopying, SCPerforming;
@class SCSearchEventListenerAnnouncer, SCStoryManagementDataSource, NSObject, NSString;
...
-(id)initWithDataSource:(id)arg1 mediaProvider:(id)arg2 playerProvider:(id)arg3 ;
