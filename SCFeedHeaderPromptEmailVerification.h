...
@class SCUserSession, UINavigationController, SCHighRiskAccountEmailPromptExperimentContext, SCVerifyEmailPromptExperimentContext, SCReauthenticationManager, SCEmailManager, SCHeaderPromptView, SCHeaderPromptViewModel, NSString;
...
-(BOOL)_isEmailVerificationPromptEnabled;
-(BOOL)_notInGracePeriods;
