...
@property (nonatomic,copy,readonly) NSString * encryptionIv; 
@property (nonatomic,copy,readonly) NSNumber * encrypted; 
@required
...
@property (nonatomic,copy,readonly) NSString * encryptionIv;               //@synthesize encryptionIv=_encryptionIv - In the implementation block
@property (nonatomic,copy,readonly) NSNumber * encrypted;                  //@synthesize encrypted=_encrypted - In the implementation block
