...
@interface SCGalleryEGOCipherKeyProvider : NSObject {
	...
	BOOL _accessKeychainSucceededAndKeysAvailable;
...
@property (assign,nonatomic) BOOL shouldRekey;              //@synthesize shouldRekey=_shouldRekey - In the implementation block
+(id)sharedInstance;
...
-(BOOL)_attemptToCreateAndPersistNewKey;
-(void)_announceKeysAvailableAndUnobserve;
-(void)_scheduleNextRetrievalAttempt;
-(BOOL)shouldRekey;
-(void)setShouldRekey:(BOOL)arg1 ;
-(id)masterKeyOld;
-(id)masterKeyAvoidKeyDerivation;
-(BOOL)_attemptToCreateAndPersistOldKey;
-(id)init;
