...
+(id)dictionaryWithValidationFunction:(/*function pointer*/void*)arg1 rawValue:(int)arg2 forKey:(id)arg3 ;
+(id)dictionaryWithValidationFunction:(/*function pointer*/void*)arg1 rawValues:(const int*)arg2 forKeys:(id*)arg3 count:(unsigned long long)arg4 ;
