...
@class SCUserSession, UIViewController, NSString, SCGalleryPrivateGalleryFlowNavigationController, SCGalleryPrivateGalleryEnterPasscodeViewController, SCGalleryPrivateGalleryConfirmPassphraseViewController, SCGalleryPrivateGalleryEnterPassphraseViewController, SCGalleryPrivateGalleryFinishChangeViewController, SCGalleryInformationWebViewController;
...
@property (assign,nonatomic,__weak) id<SCGalleryPrivateGalleryChangePasscodeFlowDelegate> delegate;              //@synthesize delegate=_delegate - In the implementation block
...
-(void)setDelegate:(id<SCGalleryPrivateGalleryChangePasscodeFlowDelegate>)arg1 ;
-(id<SCGalleryPrivateGalleryChangePasscodeFlowDelegate>)delegate;
-(void)_reset;
-(void)start;
