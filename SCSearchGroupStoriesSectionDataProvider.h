...
@class SCSearchFriendProvider, SCUserSession, NSArray, SCSearchEventListenerAnnouncer, NSObject, NSString;
...
-(void)_setSectionDataModel:(id)arg1 forceReload:(BOOL)arg2 ;
