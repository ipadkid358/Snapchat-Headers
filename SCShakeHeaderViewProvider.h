...
@property (nonatomic,retain) SCHeader * headerView;                 //@synthesize headerView=_headerView - In the implementation block
...
-(id)initWithTitle:(id)arg1 isBetaShake:(BOOL)arg2 ;
-(SCHeader *)headerView;
-(void)setHeaderView:(SCHeader *)arg1 ;
@end
