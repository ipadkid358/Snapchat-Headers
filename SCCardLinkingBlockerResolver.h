...
@class SCPaymentBlocker, SCPayment, SCCardLinkingViewController, NSNumber, NSString;
...
@property (nonatomic,retain) SCCardLinkingViewController * viewController;                                       //@synthesize viewController=_viewController - In the implementation block
...
-(void)setViewController:(SCCardLinkingViewController *)arg1 ;
-(SCCardLinkingViewController *)viewController;
