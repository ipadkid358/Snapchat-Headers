...
@interface SCImageProcessColorFilterSessionListenerAnnouncer : NSObject <SCImageProcessColorFilterSessionListener> {
	...
	mutex _mutex;
	shared_ptr<std::__1::vector<__weak id<SCImageProcessColorFilterSessionListener>, std::__1::allocator<__weak id<SCImageProcessColorFilterSessionListener> > > >* _listeners;
