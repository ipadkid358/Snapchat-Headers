...
@property (assign,nonatomic,__weak) id<SCStoriesContentViewControllingDelegate> storiesContentViewControllerDelegate; 
...
-(void)setStoriesContentViewControllerDelegate:(id)arg1;
