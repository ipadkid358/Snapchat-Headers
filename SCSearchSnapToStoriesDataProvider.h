...
@class SCExperimentManager, NSDictionary, NSArray, NSDate, SCSearchUpdateListenerAnnouncer, SCSearchCachedRequestManager, NSString;
...
-(void)_fetchDynamicStoriesForcedReload:(BOOL)arg1 ;
-(BOOL)_shouldForceReload;
-(void)_updateSnapToStoriesWithResponse:(id)arg1 searchStoryIDForStoryID:(id)arg2 shouldUpdateForceReloadTimestamp:(BOOL)arg3 ;
