...
+(void)collectStickerFromSearcher:(id)arg1 fuzzyTags:(id)arg2 tagFrequency:(id)arg3 numberOfBitmojisShown:(long long)arg4 numberOfStickersShown:(long long)arg5 rankingMethod:(long long)arg6 shouldIncludeFriendBitmoji:(BOOL)arg7 completionHandler:(/*^block*/id)arg8 ;
