...
-(id)_strippedPackID:(BOOL)arg1 ;
-(id)_strippedStickerID:(BOOL)arg1 ;
-(id)_loggingParamtersWithGeoStickerId:(BOOL)arg1 ;
-(id)_shortLoggingNameWithGeoStickerId:(BOOL)arg1 ;
