...
#import <Snapchat/SCURLBLockerViewControllerDelegate.h>

@protocol SCSnapCashBlockerResolutionResultDelegateV2;
@class SCPaymentBlocker, SCPayment, SCURLBlockerViewController, NSNumber, NSString;
...
@property (nonatomic,retain) SCURLBlockerViewController * viewController;                                        //@synthesize viewController=_viewController - In the implementation block
...
-(void)setViewController:(SCURLBlockerViewController *)arg1 ;
-(SCURLBlockerViewController *)viewController;
