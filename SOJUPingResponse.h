...
@property (nonatomic,copy,readonly) NSString * pingId; 
@required
-(NSString *)idValue;
...
@property (nonatomic,copy,readonly) NSString * pingId;                       //@synthesize pingId=_pingId - In the implementation block
