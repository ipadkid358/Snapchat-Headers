...
@class SCUserSession, UIViewController, NSString, SCGalleryPrivateGalleryFlowNavigationController, SCGalleryPrivateGalleryForgotPassphraseViewController, SCGalleryPrivateGalleryFinishChangeViewController, SCGalleryPrivateGalleryEnterPasscodeViewController, SCGalleryPrivateGalleryConfirmPassphraseViewController, SCGalleryPrivateGalleryEnterPassphraseViewController, SCGalleryInformationWebViewController;
...
@property (assign,nonatomic,__weak) id<SCGalleryPrivateGalleryForgotPasscodeFlowDelegate> delegate;              //@synthesize delegate=_delegate - In the implementation block
...
-(void)setDelegate:(id<SCGalleryPrivateGalleryForgotPasscodeFlowDelegate>)arg1 ;
-(id<SCGalleryPrivateGalleryForgotPasscodeFlowDelegate>)delegate;
-(void)_reset;
-(void)start;
