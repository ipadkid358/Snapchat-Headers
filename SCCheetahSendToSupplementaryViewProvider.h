...
@protocol SCSearchCollectionViewSectionSupplementaryViewProviderDelegate, SCSearchActionHandling;
@class SCCheetahSendToHeaderViewModel, NSDictionary, NSString;
