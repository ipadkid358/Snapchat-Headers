...
@property (nonatomic,copy,readonly) NSString * unlockableType; 
@required
-(NSString *)unlockableId;
-(NSString *)unlockableType;
...
@property (nonatomic,copy,readonly) NSString * unlockableType;              //@synthesize unlockableType=_unlockableType - In the implementation block
