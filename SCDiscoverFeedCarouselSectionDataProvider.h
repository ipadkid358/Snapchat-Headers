...
@class SCSearchEventListenerAnnouncer, NSArray, SCUserSession, SCCheetahStoriesViewModelStorage, SCCheetahStoriesDataStore, NSObject, NSString;

@interface SCDiscoverFeedCarouselSectionDataProvider : NSObject <SCSearchUpdateListener, SCSearchSectionDataProviding> {
...
-(void)_checkAndRemoveExpiredGroupStories:(id)arg1 ;
