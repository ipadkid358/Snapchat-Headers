...
@class SCUserSessionScope, SCAuthenticatedNetworkScope, SCUserStorageScope, SCScopeExposer;
...
@property (nonatomic,retain) SCScopeExposer * friendsFeedServiceScopeExposer;                             //@synthesize friendsFeedServiceScopeExposer=_friendsFeedServiceScopeExposer - In the implementation block
...
-(SCScopeExposer *)friendsFeedServiceScopeExposer;
-(void)setFriendsFeedServiceScopeExposer:(SCScopeExposer *)arg1 ;
-(void)begin;
@end
