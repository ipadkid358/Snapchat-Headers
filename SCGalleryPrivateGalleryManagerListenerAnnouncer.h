...
@interface SCGalleryPrivateGalleryManagerListenerAnnouncer : NSObject <SCGalleryPrivateGalleryManagerListener> {
	...
	mutex _mutex;
	shared_ptr<std::__1::vector<__weak id<SCGalleryPrivateGalleryManagerListener>, std::__1::allocator<__weak id<SCGalleryPrivateGalleryManagerListener> > > >* _listeners;
