...
@property (nonatomic,copy,readonly) NSArray * suggestionCards;                       //@synthesize suggestionCards=_suggestionCards - In the implementation block
