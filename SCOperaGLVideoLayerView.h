...
@property (nonatomic,retain) SCCAEAGLView * glVideoView;              //@synthesize glVideoView=_glVideoView - In the implementation block
@property (readonly) unsigned long long hash; 
@property (readonly) Class superclass; 
@property (copy,readonly) NSString * description; 
@property (copy,readonly) NSString * debugDescription; 
+(id)layerViewWithFrame:(CGRect)arg1 ;
-(SCCAEAGLView *)glVideoView;
-(void)setGlVideoView:(SCCAEAGLView *)arg1 ;
-(void)layoutSubviews;
@end
