...
@property (nonatomic,copy,readonly) NSNumber * canReroute; 
...
@property (nonatomic,copy,readonly) NSNumber * canReroute;               //@synthesize canReroute=_canReroute - In the implementation block
