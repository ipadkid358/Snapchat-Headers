...
@class NSError, NSMutableArray, NSEnumerator, AFHTTPBodyPart, NSMutableData, NSString;
...
-(BOOL)_setCFClientFlags:(unsigned long long)arg1 callback:(/*function pointer*/void*)arg2 context:(SCD_Struct_A9205*)arg3 ;
