...
#import <Snapchat/LSAGeoDataListener.h>
...
@interface LSAGeoDataComponent : LSABaseComponent <LSAGeoDataListener> {
	...
	shared_ptr<LSAGeoDataDelegateWrapper>* _delegateWrapper;
...
+(GeoTrackingData*)cppGeoDataFromObjCGeoData:(id)arg1 ;
...
-(void)setGeoData:(id)arg1 completion:(/*^block*/id)arg2 ;
