...
@property (assign,nonatomic) BOOL channelIsSubscribedEndState;                //@synthesize channelIsSubscribedEndState=_channelIsSubscribedEndState - In the implementation block
