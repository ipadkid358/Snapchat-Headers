...
@property (nonatomic,copy,readonly) NSNumber * snapstreakExpiryTime; 
@property (nonatomic,copy,readonly) NSNumber * snapstreakCount; 
@required
-(NSNumber *)snapstreakExpiryTime;
...
@property (nonatomic,copy,readonly) NSNumber * snapstreakExpiryTime;              //@synthesize snapstreakExpiryTime=_snapstreakExpiryTime - In the implementation block
