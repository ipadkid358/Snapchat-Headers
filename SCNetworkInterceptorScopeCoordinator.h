...
@class SCNetworkUnauthorizedResponseInterceptor, SCNetworkAbusiveInterceptor, SCUserSessionScope, SCNavigationScope;
...
@property (assign,nonatomic,__weak) SCNavigationScope * navigationScope;                //@synthesize navigationScope=_navigationScope - In the implementation block
-(SCUserSessionScope *)userSessionScope;
-(void)setUserSessionScope:(SCUserSessionScope *)arg1 ;
-(SCNavigationScope *)navigationScope;
-(void)setNavigationScope:(SCNavigationScope *)arg1 ;
-(void)dealloc;
-(void)begin;
@end
