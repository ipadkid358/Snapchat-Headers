...
@protocol SCChatRequestManager, SCChatLogger;
@class SCChatV3ConversationStore, SCExperimentManager, SCSessionRequestManager, SCSnapTokenManager;
...
-(id)initWithChatRequestManager:(id)arg1 conversationStore:(id)arg2 messageStateHandler:(id)arg3 mediaStateManager:(id)arg4 mediaReferenceManager:(id)arg5 experimentManager:(id)arg6 requestManager:(id)arg7 snapTokenManager:(id)arg8 logger:(id)arg9 ;
@end
