...
@class SCSearchActionButton, SCSearchEventListenerAnnouncer, NSString;

@interface SCFriendsFeedAddFriendsTabActionButtonCell : SCSearchCollectionViewCell <SCSearchActionable, SCSearchEventAnnouncing, SCSearchEventListener> {

	SCSearchActionButton* _contactButton;
	SCSearchActionButton* _snapcodeButton;
