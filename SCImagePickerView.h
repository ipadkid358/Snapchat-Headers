...
@class SCShapeView, SCImagePickerListView, SCImagePickerDropletView, UIImpactFeedbackGenerator, UISelectionFeedbackGenerator;
...
@property (assign,nonatomic,__weak) id<SCImagePickerViewDelegate> delegate;              //@synthesize delegate=_delegate - In the implementation block
...
-(id)initWithImageCount:(unsigned long long)arg1 needOnboardingAnimation:(BOOL)arg2 compactButton:(id)arg3 ;
-(void)updateWithImage:(id)arg1 forIndex:(unsigned long long)arg2 ;
-(CGSize)containerSize;
-(void)layoutSubviews;
-(void)setDelegate:(id<SCImagePickerViewDelegate>)arg1 ;
-(CGSize)sizeThatFits:(CGSize)arg1 ;
-(id<SCImagePickerViewDelegate>)delegate;
