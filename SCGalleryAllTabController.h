...
#import <Snapchat/SCGalleryEmptyTabViewDelegate.h>
#import <Snapchat/SCGalleryImportCameraRollViewControllerDelegate.h>
#import <Snapchat/SCGalleryTabImportFromCameraRollViewDelegate.h>
#import <Snapchat/SCTimeProfilable.h>
#import <Snapchat/SCGalleryEntryViewCellDelegate.h>
#import <Snapchat/SCGalleryFeaturedStoryCellDelegate.h>
#import <Snapchat/SCLagunaAppStatusListener.h>
#import <Snapchat/SCGalleryLagunaImportHeaderDelegate.h>
#import <Snapchat/SCGalleryTabController.h>

@protocol SCGalleryTabControllerDelegate;
@class NSArray, SCMadeWithLensesCameraViewPresenter, SCGalleryMadeWithLensesEntriesProvider, SCGalleryLensProcessor, SCGalleryLensProvider, SCSentinel, SCUserSession, UIViewController, SCGalleryTabsConfiguration, SCGalleryDebugSyncStatusChecker, SCGalleryTabCollectionView, SCGalleryCollectionViewHelper, SCGalleryCollectionViewSelectionHelper, SCGalleryTabCollectionViewFlowLayout, SCGalleryCollectionViewLayoutCalculator, SCGalleryEmptyTabView, SCGalleryPhotoLibraryFetcher, NSMutableArray, NSHashTable, SCGalleryPreviewController, SCGallerySendController, SCGalleryLagunaImportHeader, NSString;
...
@interface SCGalleryAllTabController : NSObject <UICollectionViewDataSource, UICollectionViewDelegate, UICollectionViewDelegateFlowLayout, SCGalleryCollectionViewHelperDataSource, SCGalleryCollectionViewSelectionHelperDataSource, SCGalleryCollectionViewSelectionHelperDelegate, SCGalleryEmptyTabViewDelegate, SCGalleryImportCameraRollViewControllerDelegate, SCGalleryTabImportFromCameraRollViewDelegate, SCTimeProfilable, SCGalleryEntryViewCellDelegate, SCGalleryFeaturedStoryCellDelegate, SCLagunaAppStatusListener, SCGalleryLagunaImportHeaderDelegate, SCGalleryTabController> {
	...
	BOOL _showingImportFromCameraRollView;
	...
	BOOL _shouldDisplayYES2017ToolTip;
...
-(void)getNewMadeWithLensesDataWithOriginalEntries:(id)arg1 completion:(/*^block*/id)arg2 ;
-(void)stopFetchingMadeWithLensesData;
-(BOOL)_shouldShowEmptyTabView;
...
-(CGSize)madeWithLensesCellSize;
-(UIEdgeInsets)madeWithLensesSectionEdgeInsetsForCollectionView:(id)arg1 ;
...
-(BOOL)_shouldShowImportFromCameraRollView:(id)arg1 ;
...
-(CGSize)_itemSizeForContainerRect:(CGRect)arg1 ;
-(void)_getNewMadeWithLensesDataWithOriginalEntries:(id)arg1 completion:(/*^block*/id)arg2 ;
-(SCD_Struct_SC329)_madeWithLensesThumbnailMediaScenePath;
