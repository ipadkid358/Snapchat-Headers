...
+(id)dictionaryWithUInt32:(unsigned)arg1 forKey:(BOOL)arg2 ;
+(id)dictionaryWithUInt32s:(const unsigned*)arg1 forKeys:(const BOOL*)arg2 count:(unsigned long long)arg3 ;
+(id)dictionary;
