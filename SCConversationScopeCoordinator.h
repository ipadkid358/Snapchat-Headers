...
@interface SCConversationScopeCoordinator : SCScopeCoordinator {

	SCUserSessionScope* _userSessionScope;
	SCUserStorageScope* _userStorageScope;
	SCScopeExposer* _conversationScopeExposer;
...
@property (nonatomic,retain) SCScopeExposer * conversationScopeExposer;                 //@synthesize conversationScopeExposer=_conversationScopeExposer - In the implementation block
...
-(SCScopeExposer *)conversationScopeExposer;
-(void)setConversationScopeExposer:(SCScopeExposer *)arg1 ;
-(id)end;
-(void)begin;
@end
