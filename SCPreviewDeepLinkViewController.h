...
@class NSDictionary, NSString, SCDeepLinkURL, SCLoadingIndicatorView, NSURL, NSMutableArray;
...
@property (nonatomic,copy) NSURL * mainContentUrl;                                          //@synthesize mainContentUrl=_mainContentUrl - In the implementation block
...
-(void)setMainContentUrl:(NSURL *)arg1 ;
-(void)finishLoadPreviewContent;
-(NSURL *)mainContentUrl;
