...
@property (nonatomic,readonly) BOOL shouldSendClearTextKey;              //@synthesize shouldSendClearTextKey=_shouldSendClearTextKey - In the implementation block
-(id)initWithDevices:(id)arg1 shouldSendClearTextKey:(BOOL)arg2 ;
