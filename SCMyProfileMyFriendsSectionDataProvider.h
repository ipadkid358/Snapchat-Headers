...
@class SCSearchEventListenerAnnouncer, NSObject, NSString;

@interface SCMyProfileMyFriendsSectionDataProvider : NSObject <SCSearchSectionDataProviding> {
...
-(id)_getOptionCellLayoutAttributes:(BOOL)arg1 ;
