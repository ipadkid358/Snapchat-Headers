...
@interface SCImageProcessLookupYUVCommand : SCImageProcessCommand {
	...
	int _imageTexture2;
	unsigned _lookupTexture;
	int _luminanceTexture;
	int _chrominanceTexture;
	int _yuvConversionMatrix;
	CGImageRef _lookupTable;

}

@property (assign,nonatomic) CGImageRef lookupTable;              //@synthesize lookupTable=_lookupTable - In the implementation block
...
-(id)initWithLookupTable:(CGImageRef)arg1 ;
-(void)dealloc;
-(void)setLookupTable:(CGImageRef)arg1 ;
-(CGImageRef)lookupTable;
-(void)unload;
@end
