...
@property (nonatomic,readonly) CAShapeLayer * redBorderLayer;              //@synthesize redBorderLayer=_redBorderLayer - In the implementation block
-(CGSize)previousBoundsSize;
-(void)setPreviousBoundsSize:(CGSize)arg1 ;
-(CAShapeLayer *)redBorderLayer;
-(id)init;
