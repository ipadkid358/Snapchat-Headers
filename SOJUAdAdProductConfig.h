...
@property (nonatomic,copy,readonly) NSDictionary * targetingParams; 
@required
...
@property (nonatomic,copy,readonly) NSDictionary * targetingParams;              //@synthesize targetingParams=_targetingParams - In the implementation block
